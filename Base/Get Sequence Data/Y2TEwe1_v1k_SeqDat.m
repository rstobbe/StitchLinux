...
function [ExpPars,PanelOutput,err] = Y2TEwe1_v1k_SeqDat(MrProt,DataInfo)

err.flag = 0;
err.msg = '';

Status2('busy','Load ''Y2TEwe1'' Sequence Info',2);
...
Panel(19,:) = {'','','Output'};
Panel(20,:) = {'Shift1 (mm)',ExpPars.shift(1),'Output'};
Panel(21,:) = {'Shift2 (mm)',ExpPars.shift(2),'Output'};
Panel(22,:) = {'Shift3 (mm)',ExpPars.shift(3),'Output'};
Panel(23,:) = {'','','Output'};
N = 23;
for n = 1:9
