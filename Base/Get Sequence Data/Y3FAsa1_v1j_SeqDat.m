...
function [ExpPars,PanelOutput,err] = Y3FAsa1_v1j_SeqDat(MrProt,DataInfo)

err.flag = 0;
err.msg = '';

Status2('busy','Load ''Y3FAsa1'' Sequence Info',2);
...
ExpPars.Sequence.flip1 = MrProt.adFlipAngleDegree{1};             % in degrees
ExpPars.Sequence.flip2 = MrProt.adFlipAngleDegree{2};             % in degrees
ExpPars.Sequence.flip3 = MrProt.adFlipAngleDegree{3};             % in degrees
...
Panel(7,:) = {'Flip1 (degrees)',ExpPars.Sequence.flip1,'Output'};
Panel(8,:) = {'Flip2 (degrees)',ExpPars.Sequence.flip2,'Output'};
Panel(9,:) = {'Flip3 (degrees)',ExpPars.Sequence.flip3,'Output'};
Panel(10,:) = {'','','Output'};
Panel(11,:) = {'rfdur (us)',ExpPars.Sequence.rfpulselen,'Output'};
Panel(12,:) = {'rdwn (us)',ExpPars.Sequence.rdwn,'Output'};
Panel(13,:) = {'flamplitude',ExpPars.Sequence.flamplitude,'Output'};
Panel(14,:) = {'rfspoil (deg)',ExpPars.Sequence.rfspoil,'Output'};
Panel(15,:) = {'trbuf (us)',ExpPars.Sequence.trbuf,'Output'};
Panel(16,:) = {'relslab',ExpPars.Sequence.relslab,'Output'};
Panel(17,:) = {'asymmref',ExpPars.Sequence.asymmref,'Output'};
